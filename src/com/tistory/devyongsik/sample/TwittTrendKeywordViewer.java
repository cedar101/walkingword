...
public class TwittTrendKeywordViewer {
           ...
           public static void main(String[] args) throws TwitterException, IOException {
                     ...
                     viewer.execute();
                     List<TrendKeyword> result = viewer.convertData();
           ...
           private void execute() throws TwitterException, IOException {
                     int targetPage = 30;
           ...
           private class TrendKeyword implements Comparable<TrendKeyword>{
