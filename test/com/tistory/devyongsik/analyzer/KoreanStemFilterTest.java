...
public class KoreanStemFilterTest extends AnalyzerTestUtil {
	private Set<TestToken> stemmingToken = new HashSet<TestToken>();
	StringReader reader = new StringReader("사랑하고 사랑치고는 사랑커녕");
	...
	public void testStemCase() throws Exception {
		TokenStream stream = new KoreanStemFilter(new KoreanCharacterTokenizer(reader));
